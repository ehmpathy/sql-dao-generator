...
export const defineQueryFunctionInputExpressionForDomainObjectProperty = ({
  ...
  /**
   * invoiceUuid: isRefByPrimary({ of: ProviderAdsInvoice })(item.invoiceRef)
  ...
  if (
    ...
    if (!sqlSchemaProperty.isArray) {
      ...
      )}: ${nullabilityPrefix}isRefByPrimary({ of: ${referencedDomainObjectName} })(${domainObjectPropertyVariableName}) ? ${domainObjectPropertyVariableName}.uuid : (await ${castDomainObjectNameToDaoName(
        referencedDomainObjectName,
